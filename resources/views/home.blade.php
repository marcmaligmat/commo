					...
					<div class="swiper-slide dark" style="background-image: url('images/slider/swiper/1.jpg');">
						<div class="container clearfix">
							<div class="slider-caption slider-caption-center">
								<h2 data-animate="fadeInUp">Welcome to Commo</h2>
								<p class="d-none d-sm-block" data-animate="fadeInUp" data-delay="200">What do you want to learn today?</p>
							</div>
						</div>
					</div>
		...
		<footer id="footer" class="dark">
						...
						<div class="col_one_third">
							...
							<div class="widget clearfix">
								...
								<div style="background: url('images/world-map.png') no-repeat center center; background-size: 100%;">
									...
									<abbr title="Phone Number"><strong>Phone:</strong></abbr> (91) 8547 4444123<br>
									<abbr title="Fax"><strong>Fax:</strong></abbr> (91) 11 4752 12334<br>
									<abbr title="Email Address"><strong>Email:</strong></abbr> info@Commo.com
								</div>
			...
			<div id="copyrights">
				...
				<div class="container clearfix">
					...
					<div class="col_half">
						Copyrights &copy; 2019 All Rights Reserved by Commo Inc.<br>
					...
					<div class="col_half col_last tright">
						...
						<i class="icon-envelope2"></i> info@Commo.com <span class="middot">&middot;</span> <i class="icon-headphones"></i> +91-11-6541-6369 <span class="middot">&middot;</span> <i class="icon-skype2"></i> CommoOnSkype
					</div>
